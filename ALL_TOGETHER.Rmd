...
leveneTest(Mean~ Day * Condition, data= PVT)
...
two_w<- lm(Mean~Condition * Day * Time, data=PVT)
emmeans1<- emmeans(two_w, pairwise ~ Condition * Day * Time, adjust ="fdr", type = "response")
...
PVT <- PVT[!(PVT$Time==2),] # we will only look at before-test measures
...
two_w <- lm(Mean~Condition * Day, data= PVT)
...
#     ((VAS$Mean[VAS$Time==2 & VAS$ID==i & VAS$Day==1]- VAS$Mean[VAS$Time==1 & VAS$ID==i & VAS$Day==1])/VAS$Mean[VAS$Time==1 & VAS$ID==i & VAS$Day==1])
#   VAS$Diff[VAS$ID==i & VAS$Day==2] =
#     ((VAS$Mean[VAS$Time==2 & VAS$ID==i & VAS$Day==1]- VAS$Mean[VAS$Time==1 & VAS$ID==i & VAS$Day==2])/VAS$Mean[VAS$Time==1 & VAS$ID==i & VAS$Day==2])
# }
# ### CHECKING ASSUMPTIONS ####
# # Time x Condition 2-way ANOVA with interaction effect (what Borrogan did)
...
# 
# #### repeated-measures ANOVA ####
# two_w <- lm(Diff ~ Condition, data= VAS)
# exp.av <- aov(two_w)
# summary(exp.av)
# tukey.test <- TukeyHSD(exp.av)
# tukey.test$Time
