...
# remove 
PVT2<- PVT[-which(PVT$MeanRT %in% outliers),]
#visualise
d<-melt(data.frame(RT=c(PVT2$MeanRT))) # we melt to wide format
distribution_plot (d, 'MeanRT')
qqPlot(PVT2$MeanRT) # stil not normal...

# SUMMARIZE data per group
sum<- sum_3(PVT, 'Condition', 'Test', 'Day', 'MeanRT' )
sum 
