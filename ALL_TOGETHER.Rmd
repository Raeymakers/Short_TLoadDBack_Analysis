...
#ost-hoc analyses: see if performance decreased faster in HCL compared to LCL
...
pl <- plotty(PVT, emmean_dataframe, 'Day',  'Diff', 'Condition', 'response', 'Vigilance')
ggsave(pl, file=paste0(plotPrefix, "PVT_Diff.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px")
pl
