...
emmeans1<- emmeans(three_w, pairwise ~ Time*Condition*Day, adjust ="fdr")
emmean_dataframe <- summary(emmeans1)$emmeans

sum_2 (PVT, 'Day', 'Condition', 'Mean')
...
sum_3 (VAS, 'Time', 'Condition', 'Day', 'Mean')
...
## plot with error bars
pl <- plotty(EXP, emmean_dataframe, 'Time', 'Mean', 'Condition', 'emmean', 'subj CF') +
 facet_grid(.~Day)+
scale_x_discrete(labels=c("Before", "After"))
...
sum_2 (EXP1, 'Stim', 'Condition', 'Mean')

pl <- plotty(EXP1, emmean_dataframe, 'Time', 'Mean', 'Stim', 'emmean', 'subj CF') +
scale_x_discrete(labels=c("Before", "After"))
ggsave(pl, file=paste0(plotPrefix, "EXP_Plot.jpg"), width = 2500, height = 1500, dpi = 300, units = "px")
pl
```
