...
### CHECKING ASSUMPTIONS ####
# Time x Condition 2-way ANOVA with interaction effect
model <- aov(Mean ~ Condition*Time, data= EXP1)
## HOMOGENEITY OF VARIANCE
leveneTest(Mean~ Time * Condition, data= EXP1) 
...
#HCL
 VAS_f <- df$VASf[df$Time==2 & df$Condition=='HCL' & df$Day==1] - df$VASf[df$Time==1 & df$Condition=='HCL' & df$Day==1]
 ...
 #LCL
 VAS_f <- df$VASf[df$Time==2 & df$Condition=='LCL' & df$Day==1] - df$VASf[df$Time==1 & df$Condition=='LCL' & df$Day==1]
 ...
 DELTALCL_1<- corrplot(VAS_f, ACC, 'VASf delta', 'Performance delta') +ggtitle('delta correlations LCL Day 1')
  ...
  VAS_f <- df$VASf[df$Time==2 & df$Condition=='HCL' & df$Day==2] - df$VASf[df$Time==1 & df$Condition=='HCL' & df$Day==2]
 ...
 #LCL
 VAS_f <- df$VASf[df$Time==2 & df$Condition=='LCL' & df$Day==2] - df$VASf[df$Time==1 & df$Condition=='LCL' & df$Day==2]
